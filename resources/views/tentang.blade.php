        ...
        <div class="container container-about">
            <div class="row tasty-food-section align-items-center">
                ...
                <div class="col-12 col-md-6 image-content d-flex justify-content-center">
                    <img src="{{ asset('assets/img/brooke-lark-oaz0raysASk-unsplash.jpg') }}" alt="Tasty Food 1"
        ...
        <div class="container container-about">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 d-flex justify-content-center mb-4">
                    <img src="{{ asset('assets/img/fathul-abrar-T-qI_MI2EMA-unsplash.jpg') }}" alt="Visi Image 1"
                        class="img-fluid rounded-image1 me-2">
                    <img src="{{ asset('assets/img/michele-blackwell-rAyCBQTH7ws-unsplash.jpg') }}" alt="Visi Image 2"
        ...
        <div class="container container-about">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6 d-flex justify-content-center order-1 order-md-2 mb-4">
                    <img src="{{ asset('assets/img/sanket-shah-SVA7TyHxojY-unsplash.jpg') }}" alt="Misi Image"
